      ...
      <div className="container-content">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-card p-6 text-center opacity-0 animate-fade-in-up animate-delay-100 flex flex-col items-center">
            ...
            <div className="glass-card p-6 text-center opacity-0 animate-fade-in-up animate-delay-200 flex flex-col items-center">
              <div className="w-14 h-14 rounded-full bg-primary-light flex items-center justify-center mb-4">
            ...
            <div className="glass-card p-6 text-center opacity-0 animate-fade-in-up animate-delay-300 flex flex-col items-center">
              <div className="w-14 h-14 rounded-full bg-primary-light flex items-center justify-center mb-4">
          ...
          <div className="mt-16 rounded-2xl overflow-hidden h-80 shadow-card opacity-0 animate-fade-in-up animate-delay-400">
            <iframe 
              ...
              title="Mapa da localização do Instituto Perucci Lopes"
            ></iframe>
          </div>
        </div>
      </div>
