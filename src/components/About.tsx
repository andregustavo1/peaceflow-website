    ...
    <section id="about" className="section bg-neutral-50 overflow-hidden">
      <div className="container-content">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6 animation-trigger">
            ...
            <div className="grid sm:grid-cols-2 gap-6 mt-8">
              <div className="flex items-start space-x-4 animate-child">
          ...
          <div className="relative h-[400px] md:h-[500px] animation-trigger">
            ...
            <div className="absolute top-10 left-0 md:left-0 glass-card p-4 z-10 md:block">
